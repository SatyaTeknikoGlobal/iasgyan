...
<div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        ...
        <div class="col-sm-9">
		    ...
		    <h4 class="page-title">Manage Program</h4>

		    <ol class="breadcrumb">

            <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Home</a></li>

            <li class="breadcrumb-item active"><a href="javaScript:void();">Program</a></li>
          ...
          @endif
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
                  ...
                  <label for="basic-select" class="col-sm-2 col-form-label">Select Sub Coursec*</label>

                  <div class="col-sm-10">

                  <select class="form-control form-control-rounded" id="subject_list" name="subject_id" onchange="getChapter()" required="">

                    <option readonly>Select Sub Coursec</option>
           ...
           <div class="form-group row">
            ...
            <label for="input-26" class="col-sm-2 col-form-label">Programme Name*</label>

            <div class="col-sm-10">

            <input type="text" class="form-control form-control-rounded" id="input-26" placeholder="Enter Programme Name" name="name" required="">
            ...
            <label for="input-26" class="col-sm-2 col-form-label">Programme Hindi Name*</label>

            <div class="col-sm-10">

            <input type="text" class="form-control form-control-rounded" id="input-26" placeholder="Enter Programme Hindi Name" name="name_hindi">
