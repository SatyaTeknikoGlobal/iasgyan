...
<div class="card">
  ...
  <form action="{{ url ('topic_update')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row">
      ...
      <label for="input-26" class="col-sm-2 col-form-label">Topic Name*</label>

      <div class="col-sm-10">

        <input type="text" class="form-control form-control-rounded" id="input-26" placeholder="Enter Topic Name" name="name" value="{{$data->name}}" required="">
    ...
    <div class="form-group row">
      ...
      <label for="input-26" class="col-sm-2 col-form-label">Topic Hindi Name*</label>

      <div class="col-sm-10">

        <input type="text" class="form-control form-control-rounded" id="input-26" placeholder="Enter Topic Hindi Name" name="name_hindi" value="{{$data->name_hindi}}">
