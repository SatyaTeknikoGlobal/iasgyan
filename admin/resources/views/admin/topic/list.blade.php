    ...
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        ...
        <div class="col-sm-9">
		    ...
		    <h4 class="page-title">Manage Topic</h4>

		    <ol class="breadcrumb">

            <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Home</a></li>

            <li class="breadcrumb-item active"><a href="javaScript:void();">Topic</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-header"><i class="fa fa-book"></i> Topic List </div>
