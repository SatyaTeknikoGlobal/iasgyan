        ...
        <div class="card-header">Edit Banners</div>
          ...
          @endif
           ...
           <div class="form-group row">
            ...
            <input type="text" class="form-control form-control-rounded" id="input-26" placeholder="Enter Name" name="name" required="" value="{{$data->timer_text}}">
          ...
          <br>
            ...
            <label for="input-27" class="col-sm-2 col-form-label">End DateTime</label>

            <div class="col-sm-10">

              <input type="datetime-local" name="timer_end_on" class="form-control form-control-rounded" value="{{$data->timer_end_on}}" required="">
