...
class TeacherController extends Controller
{
    ...
    private function getAdminImageUrl($url,$image){
        ...
        return "https://agriadmin.devclub.co.in/public/images/".$url.'/'.$image;

    }

    private function getStorageImageUrl($image){
         return "https://agristorage.devclub.co.in/images/".$image;
    }


     private function getGalleryimage($image)
    {
          return "https://agriadmin.devclub.co.in/public/images/gallery/".$image;
    }
