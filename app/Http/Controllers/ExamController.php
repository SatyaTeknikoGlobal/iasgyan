...

{
    ...
    private function getSubjectImage($image){
        ...
        return "http://iasgyan.devclub.co.in/admin/public/images/subject/".$image;
...
//        return asset("uploads/documents/$doc");
        ...
        return "http://iasgyan.devclub.co.in/admin/public/content/video/".$doc;
    ...
    private function getVideoUrl($video){
        ...
        return "http://iasgyan.devclub.co.in/admin/public/content/video/".$video;
    ...
    private function getChapterImageUrl($image){
        return "http://iasgyan.devclub.co.in/admin/public/images/chapter/".$image;
    }
    ...
    private function getTopicImageUrl($image){
        ...
        return "http://iasgyan.devclub.co.in/admin/public/images/topic/".$image;
    ...
    public function getNotesUrl($image){
        ...
        return "https://iasgyan.devclub.co.in/admin/public/content/notes/".$image;
...

    {
        ...
        return "http://iasgyan.devclub.co.in/admin/public/content/video/";
    ...
    private function getImageUrl($image){
        return "http://iasgyan.devclub.co.in/admin/public/images/".$image;
    }


    private function getThumbImageUrl($image){
        return "http://iasgyan.devclub.co.in/admin/public/content/video/images/".$image;
    }
    ...
    private function getQuestionImageUrl($image){
        ...
        return "https://agriadmin.devclub.co.in/public/images/question/".$image;
    ...
    private function getOptionImageUrl($image){
        ...
        return "https://agriadmin.devclub.co.in/public/images/options/".$image;
    ...
    private function getSoutionImageUrl($image){
        ...
        return "https://agriadmin.devclub.co.in/public/images/solutions/".$image;
    ...
    public function paginate($items, $perPage = 3, $page = null, $options = ['path'=>'https://agriadmin.devclub.co.in/api/review_question'])
...
private function sendCertificate($name,$email,$total_makrs,$obtained,$exam_name)
{
    ...
    <img src="https://agriadmin.devclub.co.in/public/images/exam/exam.jpg" alt="Snow" style="width:100%;">
