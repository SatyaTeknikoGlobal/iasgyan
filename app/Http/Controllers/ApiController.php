...

{
    ...
    private function getTopicImageUrl($image){
        return "https://iasgyan.devclub.co.in/admin/public/images/topic/".$image;
    }

    private function getDocUrl($doc){

        return "https://iasgyan.devclub.co.in/admin/".$doc;
    ...
    private function getVideoUrl($video){
        ...
        return "https://iasgyan.devclub.co.in/admin/public/content/video/".$video;

    }

    private function getFolderImage($video,$folder){

        return "https://iasgyan.devclub.co.in/admin/public/images/$folder/".$video;
...

    {
        ...
        return "https://iasgyan.devclub.co.in/admin/public/content/video/".$video.".mp4";

    }

    private function getExamImageUrl($image){

        return "http://iasgyan.devclub.co.in/admin/public/images/exam/".$image;
    }

    private function getLiveClasses($image){

        return "https://iasgyan.devclub.co.in/admin/public/images/liveclasses/".$image;

    }

    private function getCourseImage($image){

        return "https://iasgyan.devclub.co.in/admin/public/images/course/".$image;

    }

    private function getThumbnailUrl($image){

        // return "http://iasgyan.devclub.co.in/admin/public/images/video/".$image;

        //https://iasgyan.devclub.co.in/admin/public/content/video/images/thumbnail1629275177.png
        return "https://iasgyan.devclub.co.in/admin/public/content/video/images/".$image;
...

    {
    	 ...
    	 //return "https://agri.devclub.co.in/storage/gallery/".$image;

      return "https://iasgyan.devclub.co.in/admin/public/images/gallery/".$image;
  ...
  public function run_crone(){
...

    {
        ...
        $check  = UserOtp::where(['mobile'=>$mobile,'otp'=>$otp]);
...
//            'session'=>Session::count(),
    ...
    'course_name'=>$course_name->board_name,
...
public function subscription_list(Request $request){
    ...
    $existArr = [];
///////Subscription
    $check_exist = DB::table('subscription_histories')->where('user_id',$user->id)->orderby('id','desc')->get();
    if(!empty($check_exist)){
        foreach($check_exist as $check){
            ...
            $subject = Subject::where('id',$check->subject_id)->first();
    ...
    $content['subscription_array'] = $check_exist;
////NonSubscription
